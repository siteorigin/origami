...
function origami_customizer_init(){
	// Get old settings
	if ( get_theme_mod('colors_link', false) == false ) set_theme_mod('colors_link', siteorigin_setting('colors_link_color') );
	if ( get_theme_mod('origami_page_border_color', false) == false ) set_theme_mod('origami_page_border_color', siteorigin_setting('colors_page_border_color') );
	if ( get_theme_mod('origami_footer_copyright_color', false) == false ) set_theme_mod('origami_footer_copyright_color', siteorigin_setting('colors_footer_text') );
	if ( get_theme_mod('origami_footer_copyright_link_color', false) == false ) set_theme_mod('origami_footer_copyright_link_color', siteorigin_setting('colors_footer_link') );
