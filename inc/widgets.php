...
class SiteOrigin_Widgets_CTA extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $instance['headline'] ) ) {
			echo '<h2 class="cta-headline">' . esc_html( $instance['headline'] ) . '</h2>';
		}

		if ( ! empty( $instance['text'] ) ) {
			echo '<p class="cta-sub-text">' . esc_html( $instance['text'] ) . '</p>';
		}

		if ( ! empty( $instance['url'] ) ) {
			?>
		<a href="<?php echo esc_url( $instance['url'] ); ?>" class="button cta-button <?php if ( ! empty( $instance['button_style'] ) ) {
			echo esc_attr( 'button-' . $instance['button_style'] . ' cta-button-' . $instance['button_style'] );
		} ?>">
...
class SiteOrigin_Widgets_Button extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $instance['url'] ) ) {
			?>
			<a href="<?php echo esc_url( $instance['url'] ); ?>" class="cta-button button <?php if ( ! empty( $instance['button_style'] ) ) {
				echo esc_attr( 'cta-button-' . $instance['button_style'] . ' button-' . $instance['button_style'] );
			} ?>">
				<span><?php echo esc_html( $instance['button'] ); ?></span>
			</a>
			<?php
